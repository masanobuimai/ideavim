 ...
 *
 */
public class QuickFixHandler extends CommandHandler {
  public QuickFixHandler() {
    super(new CommandName[]{new CommandName("cn", "ext"), new CommandName("cN", "ext")},
  ...
  public boolean execute(Editor editor, final DataContext context, ExCommand cmd) throws ExException {
    final String actionName = cmd.getCommand().startsWith("cn")
                              ? "GotoNextError"
                              : "GotoPreviousError";
