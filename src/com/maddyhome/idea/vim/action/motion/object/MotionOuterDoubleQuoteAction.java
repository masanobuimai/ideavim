...
/**
 */
public class MotionOuterDoubleQuoteAction extends TextObjectAction {
  public MotionOuterDoubleQuoteAction() {
    super(new Handler());
  }
  ...
  private static class Handler extends TextObjectActionHandler {
    ...
    public TextRange getRange(Editor editor, DataContext context, int count, int rawCount, Argument argument) {
      return CommandGroups.getInstance().getMotion().getQuoteRange(editor, context, count, true, '"');
    }
  }
}
